...
import company.model.impl.EmployeeImpl;
import company.model.impl.EmployeeModelImpl;
...
public class EmployeePersistenceImpl
	...
	public Employee[] findByUuid_PrevAndNext(
		...
		Employee employee = findByPrimaryKey(employeesId);
	 ...
	 */
	@Override
	public List<Employee> findByPosition(int position, int start, int end) {
	...
	public Employee findByPosition_First(
		...
		Employee employee = fetchByPosition_First(position, orderByComparator);
	...
	public Employee fetchByPosition_First(
		...
		List<Employee> list = findByPosition(position, 0, 1, orderByComparator);
	...
	public Employee findByPosition_Last(
		...
		Employee employee = fetchByPosition_Last(position, orderByComparator);
	...
	public Employee fetchByPosition_Last(
		...
		List<Employee> list = findByPosition(
	...
	protected Employee getByPosition_PrevAndNext(
		Session session, Employee employee, int position,
		OrderByComparator<Employee> orderByComparator, boolean previous) {
	...
	private FinderPath _finderPathWithPaginationFindByBank;
	private FinderPath _finderPathWithoutPaginationFindByBank;
	private FinderPath _finderPathCountByBank;
	 ...
	 */
	@Override
	public List<Employee> findByBank(int bank) {
		return findByBank(bank, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	 ...
	 */
	@Override
	public List<Employee> findByBank(int bank, int start, int end) {
		return findByBank(bank, start, end, null);
	}
	 ...
	 */
	@Override
	public List<Employee> findByBank(
		int bank, int start, int end,
		OrderByComparator<Employee> orderByComparator) {

		return findByBank(bank, start, end, orderByComparator, true);
	}
	...
	public List<Employee> findByBank(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				finderPath = _finderPathWithoutPaginationFindByBank;
				finderArgs = new Object[] {bank};
			}
		}
		else if (useFinderCache) {
			finderPath = _finderPathWithPaginationFindByBank;
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_BANK_BANK_2);
	...
	public Employee findByBank_First(
		...
		Employee employee = fetchByBank_First(bank, orderByComparator);
	...
	public Employee fetchByBank_First(
		...
		List<Employee> list = findByBank(bank, 0, 1, orderByComparator);
	...
	public Employee findByBank_Last(
		...
		Employee employee = fetchByBank_Last(bank, orderByComparator);
	...
	public Employee fetchByBank_Last(
		...
		int count = countByBank(bank);

		if (count == 0) {
			return null;
		}

		List<Employee> list = findByBank(
			bank, count - 1, count, orderByComparator);
	...
	public Employee[] findByBank_PrevAndNext(
		...
		try {
			...
			array[0] = getByBank_PrevAndNext(
				session, employee, bank, orderByComparator, true);

			array[1] = employee;

			array[2] = getByBank_PrevAndNext(
				session, employee, bank, orderByComparator, false);
	...
	protected Employee getByBank_PrevAndNext(
		Session session, Employee employee, int bank,
		OrderByComparator<Employee> orderByComparator, boolean previous) {
	...
	public void removeByBank(int bank) {
		for (Employee employee :
				findByBank(bank, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
	...
	public int countByBank(int bank) {
		FinderPath finderPath = _finderPathCountByBank;
	...
	private static final String _FINDER_COLUMN_BANK_BANK_2 =
		"employee.bank = ?";
	...
	public Employee create(long employeesId) {
		...
		employee.setPrimaryKey(employeesId);
	...
	public Employee remove(long employeesId) throws NoSuchEmployeeException {
		return remove((Serializable)employeesId);
	}
	...
	public Employee findByPrimaryKey(long employeesId)
		...
		return findByPrimaryKey((Serializable)employeesId);
	}
	...
	public Employee fetchByPrimaryKey(long employeesId) {
		return fetchByPrimaryKey((Serializable)employeesId);
	}
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindByPosition = _createFinderPath(
		...
		_finderPathWithoutPaginationFindByPosition = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByPosition",
			new String[] {Integer.class.getName()}, new String[] {"position"},
			true);

		_finderPathCountByPosition = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByPosition",
			new String[] {Integer.class.getName()}, new String[] {"position"},
			false);

		_finderPathWithPaginationFindByBank = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByBank",
			new String[] {
				Integer.class.getName(), Integer.class.getName(),
				Integer.class.getName(), OrderByComparator.class.getName()
			},
			new String[] {"bank"}, true);

		_finderPathWithoutPaginationFindByBank = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByBank",
			new String[] {Integer.class.getName()}, new String[] {"bank"},
			true);

		_finderPathCountByBank = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByBank",
			new String[] {Integer.class.getName()}, new String[] {"bank"},
			false);
	}
