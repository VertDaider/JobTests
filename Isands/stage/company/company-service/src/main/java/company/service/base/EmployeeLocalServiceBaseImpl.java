...
import company.service.EmployeeLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link company.service.impl.EmployeeLocalServiceImpl}.
 * </p>
 *
 * @author sam
 * @see company.service.impl.EmployeeLocalServiceImpl
 * @generated
 */
public abstract class EmployeeLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmployeeLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>company.service.EmployeeLocalServiceUtil</code>.
	 */
	...
	public Employee createEmployee(long employeesId) {
		return employeePersistence.create(employeesId);
	}
	...
	public Employee deleteEmployee(long employeesId) throws PortalException {
		return employeePersistence.remove(employeesId);
	}
	...
	public Employee fetchEmployee(long employeesId) {
		return employeePersistence.fetchByPrimaryKey(employeesId);
	}
	...
	public Employee getEmployee(long employeesId) throws PortalException {
		return employeePersistence.findByPrimaryKey(employeesId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setPrimaryKeyPropertyName("employeesId");
