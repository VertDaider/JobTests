 ...
 * <code>company.service.impl.EmployeeLocalServiceImpl</code> and
...
public class EmployeeLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>company.service.impl.EmployeeLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static company.model.Employee addEmployee(
		company.model.Employee employee) {
	 ...
	 */
	public static company.model.Employee createEmployee(long employeesId) {
		return getService().createEmployee(employeesId);
	}
	 ...
	 */
	public static company.model.Employee deleteEmployee(
		company.model.Employee employee) {
	 ...
	 */
	public static company.model.Employee deleteEmployee(long employeesId)
		throws com.liferay.portal.kernel.exception.PortalException {

		return getService().deleteEmployee(employeesId);
	}
	...
	public static company.model.Employee fetchEmployee(long employeesId) {
		return getService().fetchEmployee(employeesId);
	}
	 ...
	 * @throws PortalException if a employee with the primary key could not be found
	 */
	public static company.model.Employee getEmployee(long employeesId)
		throws com.liferay.portal.kernel.exception.PortalException {

		return getService().getEmployee(employeesId);
	}
	 ...
	 */
	public static company.model.Employee updateEmployee(
		company.model.Employee employee) {
