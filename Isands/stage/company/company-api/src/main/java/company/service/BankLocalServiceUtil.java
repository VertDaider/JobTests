 ...
 * <code>company.service.impl.BankLocalServiceImpl</code> and
...
public class BankLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>company.service.impl.BankLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static company.model.Bank addBank(company.model.Bank bank) {
	 ...
	 * @return the new bank
	 */
	public static company.model.Bank createBank(long bankId) {
	 ...
	 */
	public static company.model.Bank deleteBank(company.model.Bank bank) {
	 ...
	 */
	public static company.model.Bank deleteBank(long bankId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	public static company.model.Bank fetchBank(long bankId) {
	 ...
	 * @throws PortalException if a bank with the primary key could not be found
	 */
	public static company.model.Bank getBank(long bankId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	public static java.util.List<company.model.Bank> getBanks(
		int start, int end) {
	 ...
	 */
	public static company.model.Bank updateBank(company.model.Bank bank) {
