...
public class EmployeeUtil {
	...
	public static Employee[] findByUuid_PrevAndNext(
		...
		return getPersistence().findByUuid_PrevAndNext(
			employeesId, uuid, orderByComparator);
	}
	 ...
	 */
	public static Employee create(long employeesId) {
		return getPersistence().create(employeesId);
	}
	 ...
	 * @throws NoSuchEmployeeException if a employee with the primary key could not be found
	 */
	public static Employee remove(long employeesId)
		throws company.exception.NoSuchEmployeeException {

		return getPersistence().remove(employeesId);
	}
	 ...
	 * @throws NoSuchEmployeeException if a employee with the primary key could not be found
	 */
	public static Employee findByPrimaryKey(long employeesId)
		throws company.exception.NoSuchEmployeeException {

		return getPersistence().findByPrimaryKey(employeesId);
	}
	 ...
	 */
	public static Employee fetchByPrimaryKey(long employeesId) {
		return getPersistence().fetchByPrimaryKey(employeesId);
	}
